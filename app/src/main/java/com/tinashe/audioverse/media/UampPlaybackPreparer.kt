...
import com.tinashe.audioverse.media.extensions.album
import com.tinashe.audioverse.media.extensions.id
import com.tinashe.audioverse.media.extensions.toMediaSource
import com.tinashe.audioverse.media.extensions.trackNumber
...
class UampPlaybackPreparer(
    ...
    override fun onPrepareFromMediaId(mediaId: String?, extras: Bundle?) {
        musicSource.whenReady {
            ...
            if (itemToPlay == null) {
                Timber.e("Content not found: MediaID=$mediaId")
